...
/**
 * This strategy class implements the strategies 
 * for shuffle or unshuffling a Loopable player
 * 
 * @author Alessandro
 *
 */
public enum LoopStrategy implements ButtonStrategy<LoopablePlayer, StrategicalButton<LoopablePlayer>> {
	...
	private BiConsumer<StrategicalButton<LoopablePlayer>, PlayerState> updater;

	private LoopStrategy(final String title, final ImageIcon img,
			final Consumer<LoopablePlayer> ctrlUser,
			final BiConsumer<StrategicalButton<LoopablePlayer>, PlayerState> updater) {
		this.title = title;
		this.img = img;
	...
	@Override
	public void update(StrategicalButton<LoopablePlayer> button,
			PlayerState status) {
